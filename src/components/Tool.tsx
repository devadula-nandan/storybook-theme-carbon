...
import carbonVariablesCSS from "../styles/carbon-theme-variables.scss";
import toolbarCSS from "../styles/toolbar.scss";
import sidenavCSS from "../styles/sidenav.scss";
...
const applyTheme = (themeValue: string) => {
  ...
  injectStyles([
    { id: "carbon-theme-variables", css: carbonVariablesCSS },
    { id: "carbon-toolbar-style", css: toolbarCSS },
    { id: "carbon-sidenav-style", css: sidenavCSS },
    { id: "carbon-panel-style", css: panelCSS },
    { id: "carbon-common-style", css: commonCSS },
  ]);
